/*
Let, const ou readonly / 3c. readonly
======================================
...
{
  /*
  Pour les tableaux, on peut utiliser "ReadonlyArray<number>" ou "readonly number[]" pour déclarer un tableau
  dont les valeurs ne peuvent pas être modifiées.
  */
