...
*/
{
  ...
  /* PROBLEME 2 */
  // Javascript n'a pas de type "enum" nativement, le transpileur est donc obligé de créer du code compliqué qui va alourdir le bundle final :
  //   let DirectionEnum;
  ...
  {
    /* PROBLEME 3 */
    // On ne peut étendre un enum, mais on peut étendre une union
    enum DirectionEnum {
      Left = 'left',
      Right = 'right',
      Top = 'top',
